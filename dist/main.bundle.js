...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__currency_currency_component__ = __webpack_require__("./src/app/currency/currency.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_34__currency_currency_component__["a" /* CurrencyComponent */]
            ],
            imports: [
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__currency_currency_component__ = __webpack_require__("./src/app/currency/currency.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ROUTES = [
    ...
    {
        path: 'currency',
        component: __WEBPACK_IMPORTED_MODULE_12__currency_currency_component__["a" /* CurrencyComponent */]
    },
    {
        path: '**',
        redirectTo: ''
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__models_currency__ = __webpack_require__("./src/app/models/currency.ts");
...
var CurrencyComponent = /** @class */ (function () {
    function CurrencyComponent(currencyService, authService) {
        this.currencyService = currencyService;
        this.authService = authService;
        this.selectedCurrency = new __WEBPACK_IMPORTED_MODULE_1__models_currency__["a" /* Currency */];
        this.loading = false;
        this.islogged = false;
    }
    ...
    CurrencyComponent.prototype.refrescar = function () {
        this.islogged = false;
        if (this.authService.islogged == true) {
            this.islogged = true;
        }
    };
    CurrencyComponent.prototype.editarCurrency = function (currency) {
        console.log('edit', currency);
        this.selectedCurrency = Object.assign({}, currency);
    };
    CurrencyComponent.prototype.editarCurrencySave = function (currency) {
        var _this = this;
        this.currencyService.editarCurrency(currency.currency)
            .then(function (data) {
            _this.obtenerCurrencies();
            currency.form.reset();
        })
    ...
    CurrencyComponent.prototype.borrarCurrency = function (currency) {
        var _this = this;
    ...
    CurrencyComponent.prototype.obtenerCurrencies = function () {
        var _this = this;
        this.currencyService.obtenerCurrency().subscribe(function (data) {
            _this.currencies = data.currency;
        }, function (error) {
            console.log('error', error);
        });
        // .then(data => {
    ...
    CurrencyComponent.prototype.agregarLugar = function (currency) {
        var _this = this;
        this.loading = true;
    ...
    CurrencyComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_currency_service__["a" /* CurrencyService */], __WEBPACK_IMPORTED_MODULE_3__services_auth_service__["a" /* AuthService */]])
    ], CurrencyComponent);
...
var CurrencyService = /** @class */ (function () {
    function CurrencyService(dataService) {
        this.dataService = dataService;
    }
    CurrencyService.prototype.obtenerCurrency = function () {
        return this.dataService.get('/api/currency');
    };
    CurrencyService.prototype.agregarCurrency = function (currency) {
        return this.dataService.post('/api/currency', { 'currency': currency });
    };
    CurrencyService.prototype.borrarCurrency = function (currency) {
        try {
    ...
    CurrencyService.prototype.editarCurrency = function (currency) {
